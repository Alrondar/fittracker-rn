-- Точная копия тела save_program_snapshot из prod на 25.09.2026
-- (pg_get_functiondef, пробелы/переносы сохранены как в дампе, кроме \r\n → \n).
-- Назначение: baseline для отката миграции 20260925161000 (FD-4) и источник
-- правды о функции, которой раньше не было в репо (drift, SEC-15).
-- Не миграция — не применять напрямую.
