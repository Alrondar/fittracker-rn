          ...
          {phases.map((phase, phaseIndex) => (
            <PhaseCard
              ...
              getIntensityInfo={(intensity: string) => {
                switch (intensity) {
                  case 'high': return { label: 'Высокая', color: colors.error, icon: null };
                  case 'medium': return { label: 'Средняя', color: colors.warning, icon: null };
                  case 'low': return { label: 'Низкая', color: colors.success, icon: null };
                  default: return { label: intensity, color: colors.textSecondary, icon: null };
                }
              }}
              onMoveUp={() => {}}
              onMoveDown={() => {}}
