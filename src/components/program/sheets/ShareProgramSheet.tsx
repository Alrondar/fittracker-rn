        ...
        <View style={{ padding: SPACING.xl }}>
          {loading ? (
            <View style={{ alignItems: 'center', paddingVertical: SPACING.xl }}>
              ...
              <Text style={[typography.body, { color: colors.textSecondary, marginTop: SPACING.md }]}>Создаём код...</Text>
            </View>
          ) : code ? (
            <>
              ...
              <View style={{ backgroundColor: colors.surfaceSecondary, borderRadius: BORDER_RADIUS.lg, padding: SPACING.lg, alignItems: 'center', marginBottom: SPACING.lg }}>
              ...
              <TouchableOpacity
                onPress={onShare}
                activeOpacity={0.8}
                style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: SPACING.sm, backgroundColor: colors.primary, paddingVertical: SPACING.md, borderRadius: BORDER_RADIUS.lg }}
              >
