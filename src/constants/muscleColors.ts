...
export const MUSCLE_COLORS: Record<string, string> = {
  ...
  'спина': '#3B82F6',      // Синий
  'ноги': '#10B981',       // Зелёный (изумрудный)
  'плечи': '#F59E0B',      // Оранжевый (янтарный)
  'руки': '#8B5CF6',       // Фиолетовый ← было зелёное, теперь фиолетовое
  'пресс и кор': '#EC4899',// Розовый
  'ягодицы': '#EAB308',    // Жёлтый (золотой) ← было ярко-жёлтое, теперь насыщеннее
  'икры': '#14B8A6',       // Бирюзовый (тиловый)
  'предплечья': '#6366F1', // Индиго
  'трапеция': '#A855F7',   // Пурпурный (фиолетовый светлый)
};
