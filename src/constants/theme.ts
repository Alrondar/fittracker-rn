...
// UX-3 (audit-2): канонические уровни elevation. Единственный владелец
// теней в приложении — инлайновые копии shadowColor/elevation запрещены.
// Android берёт elevation, iOS — shadow* группу; значения согласованы так,
// чтобы md/lg были заметны на светлом surface, но не «ныряли» в dark.
