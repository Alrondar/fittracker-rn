...
| PROG-4 | 🔴 | ✅ | полный аудит вложенности: строка упражнения в редакторе упрощена (название, мышцы, подходы); детали (отдых, интенсивность) вынесены в `ExerciseSettingsSheet` |
| PROG-5 | 🔴 | ✅ | progressive disclosure в Editor: UI не раскрывает всю вложенность одновременно, drag-and-drop сохранён, визуальный шум снижен |
