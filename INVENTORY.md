...
| `utils/intensityInfo.tsx` |getIntensityInfo: label/color/bgColor/icon для intensity badge (PR8)|
| `engine/progression.ts` |calculateProgression: правила прогрессии (ENG-1); explainProgression: structured reasons (ENG-2). Чистые функции, директория — задел Phase B|
